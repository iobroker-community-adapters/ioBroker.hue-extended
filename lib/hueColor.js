/*
 * Source: https://github.com/peter-murray/node-hue-api
 * by https://github.com/peter-murray
 *
 * License (https://github.com/peter-murray/node-hue-api#license)
********************************************************************************
...
function _getXYStateFromRGB(red, green, blue, limits) {
    ...
    return [xyPoint.x.toFixed(4), xyPoint.y.toFixed(4)];
}
