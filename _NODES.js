module.exports =
{
	...
	"STATES":
	{
		...
		"sensors.config.battery": {"description": "Current battery level", "role": "value.battery", "type": "number", "common": {"unit": "%"}},
		...
		"sensors.config.temperature": {"description": "Temperature", "role": "value.temperature", "type": "number", "common": {"unit": "°C"}, "convert": "percentage"},
		...
		"sensors.state.temperature": {"description": "Temperature", "role": "value.temperature", "type": "number", "common": {"unit": "°C"}, "convert": "percentage"},
		"sensors.state.humidity": {"description": "Humidity", "role": "value.humidity", "type": "number", "common": {"unit": "%"}, "convert": "percentage"},
